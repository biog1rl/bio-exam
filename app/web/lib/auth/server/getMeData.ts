import { buildPermissionSet, normaliseRoleKeys, PERMISSION_DOMAINS, type PermissionDomain, type PermissionKey, type RoleKey } from '@bio-exam/rbac'
...
const pool =
	globalForPg.__bioExamWebAuthPool ??
	new Pool({
