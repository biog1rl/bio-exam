...
export const MorphBlob = ({
	...
	useEffect(() => {
		...
		let frame: number
		const nextIndex = (currentIndex + 1) % morphs.length

		const interpolator = flubber.interpolate(morphs[currentIndex], morphs[nextIndex], {
	...
	return (
		<div className={`absolute z-[-1] opacity-60 blur-3xl ${className}`}>
			<svg width={width} height={height} viewBox="0 0 1 1" preserveAspectRatio="none">
				<defs>
					<linearGradient id="gradient" x1="0%" y1="0%" x2="100%" y2="100%">
						<stop offset="0%" stopColor="#6DDCFF" />
						<stop offset="100%" stopColor="#7F60F9" />
					</linearGradient>
				</defs>
				<path ref={pathRef} d={morphs[0]} fill="url(#gradient)" />
			</svg>
		</div>
	)
}
